...
export const metadata = {
  title: 'Affiliate Disclosure - SpiritedRoots',
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 lg:p-12">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sage-700 leading-relaxed">
                    At SpiritedRoots, honesty and transparency are at the heart of everything we share. 
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <span className="text-terracotta-500 text-xl mr-3">•</span>
                <p className="text-sage-700 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-sage-50 p-4 rounded-lg">
                <h3 className="font-semibold text-sage-900 mb-2">Amazon Associates</h3>
                <p className="text-sage-700 text-sm">
                  Books, household items, and everyday products we use and recommend
                </p>
              </div>
              <div className="bg-sage-50 p-4 rounded-lg">
                <h3 className="font-semibold text-sage-900 mb-2">ShareASale Network</h3>
                <p className="text-sage-700 text-sm">
                  Specialty natural living brands and eco-friendly companies
                </p>
              </div>
              <div className="bg-sage-50 p-4 rounded-lg">
                <h3 className="font-semibold text-sage-900 mb-2">Thrive Market</h3>
                <p className="text-sage-700 text-sm">
                  Organic foods, natural products, and household essentials
                </p>
              </div>
              <div className="bg-sage-50 p-4 rounded-lg">
                <h3 className="font-semibold text-sage-900 mb-2">Individual Brand Partnerships</h3>
                <p className="text-sage-700 text-sm">
            ...
            <div className="bg-cream-100 p-6 rounded-lg">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-sage-700">Honest opinions based on real use in our family</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gold-500 mr-2">✓</span>
                  <span className="text-sage-700">Both pros and cons of every product</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gold-500 mr-2">✓</span>
                  <span className="text-sage-700">Clear information about who might (or might not) benefit</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gold-500 mr-2">✓</span>
                  <span className="text-sage-700">Alternatives and budget-friendly options when available</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gold-500 mr-2">✓</span>
                  <span className="text-sage-700">Updates if our opinion changes over time</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-sage-50 p-4 rounded-lg">
              <p className="text-sage-700">
                <strong>Contact us:</strong> Find us on social media @SpiritedRoots or visit our 
                <a href="/about" className="text-sage-600 hover:text-sage-800 underline"> About page</a> for more ways to connect.
              </p>
            </div>
          </section>

          {/* Last Updated */}
          <section className="text-center pt-6 border-t border-sage-200">
            <p className="text-sage-600 text-sm">
              This disclosure was last updated on September 4, 2025
            </p>
          </section>
